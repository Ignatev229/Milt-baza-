...
Item {
    ...
    function reportDataCSVBuilder()
    {
        ...
        for (var i = 0; i < sectionedModel.count; i++) {
            ...
            // -1 mean not visible
            if(_bodyRNumber >= 1)
                reportData += Number(item.bodyR.replace("$", "")).toFixed(2)   + ","

            if(_bodyRNumber >= 2)
                reportData += Number(item.body2R.replace("$", "")).toFixed(2)  + ","
                 
            if(_bodyRNumber >= 3)
                reportData += Number(item.body3R.replace("$", "")).toFixed(2)  + ","

            if(_bodyRNumber >= 4)
                reportData += Number(item.body4R.replace("$", "")).toFixed(2)  + ","

            if(_bodyRNumber >= 5)
                reportData += Number(item.body5R.replace("$", "")).toFixed(2)  + ","

            if(_bodyRNumber >= 6)
                reportData += Number(item.body6R.replace("$", "")).toFixed(2)  + ","

            if(_bodyRNumber >= 7)
                reportData += Number(item.body7R.replace("$", "")).toFixed(2)  + ","
 
            if(_bodyRNumber >= 8)
                reportData += Number(item.body8R.replace("$", "")).toFixed(2)  + ","

            if(_bodyRNumber >= 9)
                reportData += Number(item.body9R.replace("$", "")).toFixed(2)  + ","

            if(_bodyRNumber >= 10)
                reportData += Number(item.body10R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 11)
                reportData += Number(item.body11R.replace("$", "")).toFixed(2) + ",";
                
            if(_bodyRNumber >= 12)
                reportData += Number(item.body12R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 13)
                reportData += Number(item.body13R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 14)
                reportData += Number(item.body14R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 15)
                reportData += Number(item.body15R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 16)
                reportData += Number(item.body16R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 17)
                reportData += Number(item.body17R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 18)
                reportData += Number(item.body18R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 19)
                reportData += Number(item.body19R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 20)
                reportData += Number(item.body20R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 21)
                reportData += Number(item.body21R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 22)
                reportData += Number(item.body22R.replace("$", "")).toFixed(2) + ","

            if(_bodyRNumber >= 23)
                reportData += Number(item.body23R.replace("$", "")).toFixed(2) + ","
